...
discord_api_key = "MzE1MTg2NzU0NjAyNjYzOTM4.G9Ym5Y.OCqQSB7D7EsonwRZhM1wrNhVGiClwlGF0xmzOw"
...
UseUserHistory = False # Set to True to enable channel history (Multi-user mode)
UserHistoryAmount = 0

UseChannelHistory = True # Set to True to enable channel history (Multi-user mode)
...
UserRateLimitSeconds = 15 # set to the number of seconds to wait the same user is allowed to submit a prompt
...
DuckDuckGoMaxSearchResults = 25 # set to the maximum number of search results to fetch from DuckDuckGo
